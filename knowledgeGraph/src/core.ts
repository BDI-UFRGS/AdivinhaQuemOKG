...
export function serializeKnowledgeGraph(graph: KnowledgeGraph): KnowledgeGraphDTO {
  return {
...
export function deserializeKnowledgeGraph(dto: KnowledgeGraphDTO): KnowledgeGraph {
  return {
...
export function cloneKnowledgeGraph(graph: KnowledgeGraph): KnowledgeGraph {
  return {
    nodes: graph.nodes.map((node) => ({ ...node })),
    links: graph.links.map((link) => ({ ...link })),
    index: {
